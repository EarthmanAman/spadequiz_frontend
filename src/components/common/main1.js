    ...
    return (
    	<div className="main-div">
            ...
            <div className="main-content-div">
                {(this.state.message_visible && this.props.message !== null && this.props.message !== undefined) ? <div style={{"margin-right":40, "margin-left":40,}}><Alert variant={this.props.message.variant}>{this.props.message.message}</Alert></div>: null}
                {this.props.content}
